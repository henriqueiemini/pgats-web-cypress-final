...
class Cadastro {
    ...
    verificarErroEmailExistente() {
        // After clicking signup with existing email, we should either stay on login or be redirected to signup
        // Verify that we didn't proceed to the account information page
        cy.url().should('not.include', '/account_information');
        // Check that either we're on login page or signup page, but not on account creation
